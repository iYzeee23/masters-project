...
const COMPARE_STEPS: HelperStep[] = [
  ...
  {
    id: 'c-sidebar', target: '[data-help="compare-sidebar"]', position: 'bottom',
    title: 'Izbor algoritama',
    titleEn: 'Algorithm Selection',
    content: 'Kliknite na čipove da izaberete koje algoritme želite da uporedite. Koristite "Select All" da izaberete sve, ili ✕ da poništite izbor.',
    contentEn: 'Click chips to select which algorithms to compare. Use "Select All" to select everything, or ✕ to clear.',
  },
  {
    id: 'c-settings', target: '[data-help="compare-settings"]', position: 'bottom',
    title: 'Heuristika i susedi',
    titleEn: 'Heuristic & Neighbors',
    content: 'Heuristika usmerava pretragu ka cilju (Manhattan, Euclidean...). Broj suseda određuje smerove kretanja: 4 = gore/dole/levo/desno, 8 = uključujući dijagonale.',
    contentEn: 'Heuristic guides the search toward the goal (Manhattan, Euclidean...). Neighbor count determines movement: 4 = cardinal directions, 8 = including diagonals.',
  },
  {
...
const PLAYGROUND_STEPS: HelperStep[] = [
  ...
  {
    id: 'p-sidebar', target: '[data-help="playground-sidebar"]', position: 'bottom',
    title: 'Status',
    titleEn: 'Status',
    content: 'Ovde vidite broj ćelija u vašem putu i ukupnu cenu. Pratite ove brojeve dok istražujete grid.',
    contentEn: 'Here you see the number of cells in your path and the total cost. Track these numbers as you explore the grid.',
  },
  {
    id: 'p-actions', target: '[data-help="playground-actions"]', position: 'bottom',
    title: 'Akcije',
    titleEn: 'Actions',
    content: 'Predajte rešenje kad završite, proglasit da put ne postoji, poništite poslednji potez ili resetujte.',
    contentEn: 'Submit your solution when done, declare no path exists, undo the last move, or reset.',
  },
  {
