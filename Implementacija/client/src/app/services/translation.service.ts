...
const SR: Translations = {
  ...
  'toolbar.pause': '⏸ Pauza',
  'toolbar.step': '▶ Korak',
  'toolbar.stepBack': '◀ Nazad',
  'toolbar.begin': '⏮ Početak',
  'toolbar.end': '⏭ Kraj',
  'toolbar.speed': '⚡ Brzina',
  'toolbar.animSpeed': 'Brzina animacije',
  'toolbar.maps': '🗺 Mape',
  'toolbar.generate': '✨ Generiši',
  'ai.generate': 'Generiši',
  'ai.tutor': 'Tutor',
  'ai.recommend': 'Preporuka',
  ...
  'toolbar.gridSize': 'Veličina',
  'toolbar.rows': 'Red:',
  'toolbar.cols': 'Kol:',
  'toolbar.applySize': 'Primeni',
  'toolbar.default': 'Osnovno',
  'toolbar.gridLabel': 'Mreža',
  'toolbar.weightLabel': 'Težina',
  'toolbar.zeroOneHint': 'Težina je fiksna (0 ili 1)',
  ...
  // Playground
  'playground.instructions': 'Pokušaj da repliciraš put izabranog algoritma! Klikni na ćelije od starta do cilja.',
  ...
  'playground.selectAlgo': 'Algoritam za repliciranje:',
  'playground.userLabel': 'Tvoj put',
  'playground.algoLabel': 'Put algoritma',
  'playground.matchBonus': 'Bonus (tačan put):',
  'playground.expanded': 'Prošireni čvorovi:',
  'playground.aiEvaluation': 'Ocena',
  'playground.aiInsight': 'Uvid',
  'playground.aiTip': 'Savet',
  'playground.aiLoading': 'AI analizira...',
  'playground.aiTitle': '\u2728 AI Feedback',
  'playground.vizOrigin': '\u23EE',
  'playground.vizEnd': '\u23ED',
...
const EN: Translations = {
  ...
  'toolbar.pause': '⏸ Pause',
  'toolbar.step': '▶ Step',
  'toolbar.stepBack': '◀ Back',
  'toolbar.begin': '⏮ Origin',
  'toolbar.end': '⏭ End',
  'toolbar.speed': '⚡ Speed',
  ...
  'toolbar.reset': '↺ Reset',
  'toolbar.clear': '✕ Clear',
  'toolbar.gridSize': 'Size',
  'toolbar.rows': 'Row:',
  'toolbar.cols': 'Col:',
  'toolbar.applySize': 'Apply',
  'toolbar.default': 'Default',
  'toolbar.gridLabel': 'Grid',
  'toolbar.weightLabel': 'Weight',
  'toolbar.zeroOneHint': 'Weight is fixed (0 or 1)',
  ...
  // Playground
  'playground.instructions': 'Try to replicate the selected algorithm\'s path! Click on cells from start to goal.',
  ...
  'playground.selectAlgo': 'Algorithm to replicate:',
  'playground.userLabel': 'Your path',
  'playground.algoLabel': 'Algorithm path',
  'playground.matchBonus': 'Bonus (exact match):',
  'playground.expanded': 'Expanded nodes:',
  'playground.aiEvaluation': 'Evaluation',
  'playground.aiInsight': 'Insight',
  'playground.aiTip': 'Tip',
  'playground.aiLoading': 'AI analyzing...',
  'playground.aiTitle': '\u2728 AI Feedback',
  'playground.vizOrigin': '\u23EE',
  'playground.vizEnd': '\u23ED',
